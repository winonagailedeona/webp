...
<head>
	...
	<!-- title -->
	<title>Winona Gaile's</title>

	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="{{ asset('images/shortcut_icon.png')}}">
	<!-- google font -->
	...
	<!-- mean menu css -->
	<link rel="stylesheet" href="{{ asset('blog/css/meanmenu.min.css')}}">
	<!-- main style -->
